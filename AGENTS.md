...
- **Commits:** conventional prefix, lowercase subject, a body explaining *why*, ending with `Co-Authored-By: Claude Opus 5 (1M context) <noreply@anthropic.com>`. No git remote is configured — commits stay local.
